...
import Curriculum from "./CVJuanSegundo.pdf";
...
const About = () => {
  ...
  let about = [
    ...
    "I started to learn programmation in 2019 at UNLP Computer University",
    "In 2020 i did introduction course of HTML & CSS in Plataforma 5",
    "In 2021 i did the course of Web Full-Stack developer at Digital House",
  ];
  let info;
